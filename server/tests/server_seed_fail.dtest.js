...
describe('DELETE /todos/:id', () => {
	...
	it('should not remove a todo item by id from another user', (done) => {
	...
	it('DELETE should return 404 if todo not found', (done) => {
		var id = new ObjectID();
	...
	it('DELETE should return 404 if object id is invalid', (done) => {
		var id = 123;
		request(app)
			.delete(`/todos/${id}`)
			.set('x-auth', users[1].tokens[0].token)
